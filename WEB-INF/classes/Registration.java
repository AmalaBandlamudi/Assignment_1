...
public class Registration extends HttpServlet {
	...
	protected void displayRegistration(HttpServletRequest request,
		...
		pw.print("<div class='post' style='float: none; width: 100%; background: slategrey;'>");
		...
		pw.print("<form method='post' action='Registration'>"
				...
				+ "</td></tr></table>"
				+ "<input type='submit' class='btnbuy' name='ByUser' value='Create User' style=':20px margin: 20px; margin-right: 85px; margin-top:20px'></input>"
				+ "</form>" + "</div></div></div>");
