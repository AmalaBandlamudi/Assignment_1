...
public class CheckOut extends HttpServlet {
	...
	protected void storeOrders(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("Choose your nearby:</td>");
		pw.print("<td><select name='delivery' id='delivery'>"+
		"<option value=''>400 E 33rd Street CHICAGO 60616 IL USA</option>"+
		"<option value=''>Midlothian Illinois USA</option>"+
		"<option value=''>Millenium CHICAGO IL 60621-2126 USA</option>"+
		"<option value=''>Prairie Shores 3200 S CHICAGO IL 60647-1568 USA</option>"+
		"<option value=''>Belmount IL 60645-7616 USA</option>"+
		"<option value=''>Michigan CHICAGO IL 60644-2457 USA</option>"+
		"<option value=''>Roosevelt CHICAGO IL 60647-7363 USA</option>"+
		"<option value=''>Naperville WELLS ST CHICAGO IL 60607-4573 USA</option>"+
		"<option value=''>Ridge CHICAGO IL 60618-1748 USA</option>"+
		"</select>");
		pw.print("<br><br>");
		pw.print("</td></tr>");
